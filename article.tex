...
This is unnoticeable for snippets of marginal size like most examples included, but when applied to functions with a significant amount of def-use paths, it can be quite consequential. For \texttt{tests/sha256.ll} for instance, the running times are effectively doubled on x86-64:

\begin{minted}{bash}
$ time dune exec build -- tests/sha256.ll  -t lva -r
[..]
dune exec build [..] -t lva -r  33,69s user 0,04s system 99% cpu 33,765 total
$ time dune exec build -- tests/sha256.ll  -t lva
[..]
dune exec build [..] -t lva  17,26s user 0,05s system 99% cpu 17,335 total
\end{minted}
