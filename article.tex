...
The primary sources will be \textit{Modern Compiler Implementation in ML} \parencite{AppelAndrewW} and \textit{Compilers: Principles, techniques, and tools} by \parencite{alma99122774374105763}, in addition to scientific publications concerning the linear scan approach.
