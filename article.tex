...
Therefore, the x86 that is generated essentially amounts to an \texttt{imul} instruction as can be seen in Figure 
...
\hline
\end{NiceTabular}}
\caption{\label{tab:factori32}Benchmark of \texttt{benches/factori32.ll} output by \mintinline{bash}{dune exec bench -- -f factori32 -n 1000}}
\end{table}
