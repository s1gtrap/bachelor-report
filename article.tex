...
Conversely, managed languages such as Java and C\# typically don't depend on the LLVM toolchain directly, some research projects attempt to compile associated VM bytecode to a native platform using LLVM (\cite{dotnet}).
