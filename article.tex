...
A continuous sequence of instructions is referred to as a \textit{basic block}, which is defined as a sequence with no branches in or out except for the first instruction, following immediately after the function entry or a label, and the last instruction, either terminates or transferring the flow of execution. These are often referred to as terminators and can be thought of as an entirely different categoriy of instructions. % TODO: måske drop 'can be thought of'
