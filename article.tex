...
\noindent The opposite is quite similar (see Figure \ref{fig:intervalends.ml}).
...
%\node (n2) [attribute, right=of n1] {\small NODE2};
   ...
   \draw[|-|] (2)  node[above,transform canvas={xshift=1.43cm}] {\texttt{\%3}} edge [transform canvas={xshift=1.5cm}] (6);
   \draw[|-|] (3) node[above,transform canvas={xshift=0.83cm}] {\texttt{\%4}} edge [transform canvas={xshift=0.9cm}] (8);
   \draw[|-|] (4) node[above] {\texttt{\%5}} edge [ ]  (11);
...
\end{tikzpicture}
\vspace{0.7em}
     \caption{Live ranges}\label{fig:linear.lra}
   \end{minipage}
